...
\pgfkeys{
  ...
  \pgfkeys{
    /tikz/.cd,
      ...
      beam splitter/.prefix style={shape=beam splitter,optics,draw},
      detector/.prefix style={shape=detector,optics,draw},
      fiber coupler/.prefix style={shape=fiber coupler,optics,draw},
...
\newif\iftikz@optics@lens@arrow
\tikz@optics@lens@arrowtrue
...
\pgfkeys{/tikz/optics/.cd,
  ...
  lens style/.is choice,
  lens style/arrow/.code={\tikz@optics@lens@arrowtrue},
  lens style/realistic/.code={\tikz@optics@lens@arrowfalse}
}
\pgfdeclareshape{lens}
{
  ...
  \iftikz@optics@lens@arrow
      \anchor{east}{\center}
      \anchor{west}{\center}
  \else
      \anchor{east}{\pgfpoint{-0.0152*\objectHeight/0.6946}{0cm}}
      \anchor{west}{\pgfpoint{0.0152*\objectHeight/0.6946}{0cm}}
  \fi
  ...
  \backgroundpath
  {
    \iftikz@optics@lens@arrow
      ...
      \fi
    \else
      \pgfmathsetmacro\angle{2*atan(\objectWidth/\objectHeight)}
      \pgfmathsetmacro\radius{\objectHeight/(2*sin(\angle))}
      \iftikz@optics@lens@converging
        \pgfpathmoveto{\pgfpoint{0cm}{\objectHeight/2}}
        \pgfpatharc{\angle}{-\angle}{\radius}
        \pgfpatharc{180+\angle}{180-\angle}{\radius}
      \else
        \pgfpathmoveto{\pgfpoint{\objectWidth}{-\objectHeight/2}}
        \pgfpatharc{180+\angle}{180-\angle}{\radius}
        \pgfpathlineto{\pgfpoint{-\objectWidth}{\objectHeight/2}}
        \pgfpatharc{\angle}{-\angle}{\radius}
      \fi
      \pgfclosepath
    \fi
...
\pgfdeclareshape{detector}
{
  ...
  \anchor{input}{\center}
  \anchor{output}{\pgfpoint{\objectHeight/2}{0}}
  ...
  \backgroundpath
  {
      \pgfpathmoveto{\pgfpoint{\objectHeight}{0cm}}
      \pgfpathlineto{\pgfpoint{\objectHeight/2}{0cm}}
      \pgfpathmoveto{\pgfpoint{0cm}{\objectHeight/2}}
      \pgfpatharc{90}{-90}{\objectHeight/2}
  }
  \foregroundpath{
      \pgfpathcircle{\pgfpoint{0cm}{0cm}}{\objectHeight/10}
      \pgfusepath{fill}
  }
}
...
\pgfdeclareshape{fiber coupler}
{
  ...
  \backgroundpath
  {
      \pgfpathmoveto{\pgfpoint{0cm}{\objectHeight/10}}
      \pgfpathlineto{\pgfpoint{\objectHeight/2}{\objectHeight/20}}
      \pgfpathlineto{\pgfpoint{\objectHeight/2}{-\objectHeight/20}}
      \pgfpathlineto{\pgfpoint{0cm}{-\objectHeight/10}}
      \pgfclosepath
  }
  \foregroundpath{
      \pgfpathcircle{\pgfpoint{0cm}{0cm}}{\objectHeight/10}
